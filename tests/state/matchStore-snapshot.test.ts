...
beforeEach(() => {
  ...
  useMatchStore.setState({
    ...
    tokens: [
      { uid: 'a1', side: 'a', opId: 'x', name: 'A1', pos: { x: 0, y: 0 }, facing: 0, baseRadius: 0.6, wounds: 10, maxWounds: 10, alive: true, placed: true },
      { uid: 'b1', side: 'b', opId: 'x', name: 'B1', pos: { x: 5, y: 0 }, facing: 0, baseRadius: 0.6, wounds: 10, maxWounds: 10, alive: true, placed: true },
    ],
  })
})
